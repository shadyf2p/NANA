...
class CreateImageFromPromptTab(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None):
        ...
        title.setStyleSheet('font-weight: 600; color: #d7e3ff;')
...
class CreateImageTab(QWidget):
    ...
    def __init__(self, config, on_model_changed, parent: QWidget | None = None):
        super().__init__(parent)
        self._cfg = config
        ...
        lbl.setStyleSheet('font-weight: 600; color: #d7e3ff;')
        top.addWidget(lbl)
